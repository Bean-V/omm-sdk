 ...
 */
public class Department  extends  Sort implements Serializable {
    //部门唯一标记
    ...
    //部门LOGO
    private String oort_dept_photo;
    //是否有下级部门
    ...
    public String getOort_dept_photo() {
        return oort_dept_photo;
    }

    public void setOort_dept_photo(String oort_dept_photo) {
        this.oort_dept_photo = oort_dept_photo;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof Department){
            ...
            return this.oort_dcode.equals(department.getOort_dcode());
        }
         return false;
    }
    ...
    public String toString() {
        return "Department{" +
                ...
                ", oort_dept_photo='" + oort_dept_photo + '\'' +
