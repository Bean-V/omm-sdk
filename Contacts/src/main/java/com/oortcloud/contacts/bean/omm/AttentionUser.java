 ...
 * 好友bean
 */
public class AttentionUser extends Letters {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttentionUser)) return false;
        AttentionUser that = (AttentionUser) o;
        return this.getToUserId().equals(that.getToUserId());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getToUserId());
    }
}
