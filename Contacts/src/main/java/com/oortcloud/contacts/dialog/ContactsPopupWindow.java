...
public class ContactsPopupWindow extends PopupWindow {
    ...
    public ContactsPopupWindow(final FragmentActivity context,
...
//        boolean enablePayModule = coreManager.getConfig().enablePayModule;
        ...
        ViewGroup menuView = (ViewGroup) inflater.inflate(R.layout.popu_contacts_layout, null);

        menuView.findViewById(R.id.create_group).setOnClickListener(new OnClickListener() {
            @Override
        ...
        for (int i = 0; i < menuView.getChildCount(); i++) {
            ...
            if (child instanceof LinearLayout) {
                ...
                // 不允许建群时隐藏发起群聊按钮，
//                if ((layout.getId() == R.id.create_group
...
//                }
//                // 不允许搜索时隐藏添加好友按钮，
//                if ( layout.getId() == R.id.add_friends) {
//                    layout.setVisibility(View.GONE);
//                    continue;
//                }
                // 关闭定位功能，隐藏附近的人
