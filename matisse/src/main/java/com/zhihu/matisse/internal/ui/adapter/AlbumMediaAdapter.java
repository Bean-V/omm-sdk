...
public class AlbumMediaAdapter extends
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            ischeck =true;
            mediaViewHolder.mMediaGrid.getmCheckView().setVisibility(ischeck ? View.VISIBLE : View.GONE);

            mediaViewHolder.mMediaGrid.getmThumbnail().setOnLongClickListener(new View.OnLongClickListener(){
                ...
                public boolean onLongClick(View view) {
                    ...
                    if(mOnMediaLongClickListener != null){
                        mOnMediaLongClickListener.onMediaLongClick(ischeck);
                    }
                    return true;
                }
            });
    ...
    public void onThumbnailClicked(ImageView thumbnail, Item item, RecyclerView.ViewHolder holder) {
        if (mSelectionSpec.showPreview) {
            if (mOnMediaClickListener != null) {
                mOnMediaClickListener.onMediaClick(null, item, holder.getAdapterPosition(),ischeck);
            }
        } else {
    ...
    public void registerOnMediaLongClickListener(OnMediaLongClickListener listener) {
        mOnMediaLongClickListener = listener;
    }
    ...
    public interface OnMediaClickListener {
        void onMediaClick(Album album, Item item, int adapterPosition,Boolean canCheck);
    }

    public interface OnMediaLongClickListener {
        void onMediaLongClick(Boolean canCheck);
    }
