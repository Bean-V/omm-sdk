...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    public void setmCheckView(CheckView mCheckView) {
    ...
    private void init(Context context) {
        ...
        mSysedFalg = (TextView) findViewById(R.id.tv_sysed_flag);
...
//                public void run() {
                    ...
                    try {
                        clazz = Class.forName("com.sentaroh.android.upantool.sysTask.TastTool");
                        getInstance = clazz.getMethod("getInstance");
                        fileIsSysed = clazz.getMethod("fileIsSysed", String.class);
                        Object instance = getInstance.invoke(clazz);
                        boolean o = (boolean) fileIsSysed.invoke(instance, SelectedItemCollection.getPathString(mContext, mMedia));
 //                       ((Activity)mContext).runOnUiThread(new Runnable() {
//                            @Override
//                            public void run() {
                                if(o ){
                                    mSysedFalg.setVisibility(View.VISIBLE);
                                }else{
                                    mSysedFalg.setVisibility(View.GONE);
                                }
 //                           }
 //                       });
