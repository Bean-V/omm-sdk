 ...
 */
package com.zhihu.matisse.internal.entity.loader;
...
public class AlbumMediaLoader extends CursorLoader {
    ...
    public static void getCursorOfAlbum(Context context, Album album, SelectedItemCollection.ProgressListioner progressListioner){
        String selection;
            ...
            if (cursor != null) {
                ...
                int i = 0;
                    while (cursor.moveToNext()){
                        ...
                        //lis.add(Item.valueOf(cursor));


                        String path = SelectedItemCollection.getPathString(context,item);
                        if(path != null) {
                            lis.add(path);
                        }

                        if(progressListioner != null){
                            progressListioner.progress(i * 100/cursor.getCount());
                        }
                        i++;
                    }
