...
public final class SelectionCreator {
    ...
    public SelectionCreator showCopy(boolean res) {
        mSelectionSpec.showCopy = res;
        return this;
    }
    ...
    public SelectionCreator setOnOperClikListener(@Nullable OnOperClikListener listener) {
        mSelectionSpec.onOperClikListener = listener;
        return this;
    }
