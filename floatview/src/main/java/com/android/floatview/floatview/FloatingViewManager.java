...
public class FloatingViewManager implements IFloatingView{
    ...
    @DrawableRes
    private int mIconRes = R.drawable.home;//悬浮icon
    ...
    @Override
    public FloatingViewManager listener(FloatingViewListener floatingViewListener) {
        if (mFloatingView != null) {
            mFloatingView.setMagnetViewListener(floatingViewListener);
        }
        return this;
    }
    ...
    private FrameLayout.LayoutParams getParams() {
        ...
        params.setMargins(-20, params.topMargin, params.rightMargin, 800);
        return params;
    }
