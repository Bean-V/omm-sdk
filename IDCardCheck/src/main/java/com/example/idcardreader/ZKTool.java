...
public class ZKTool extends Object {
    private ZKUSBManager zkusbManager = null;

    private boolean bRepeatMode = true;
    ...
    public interface ReadCallback{
        void callback(IDCardInfo info);
        void callbackpr(IDPRPCardInfo info);
    }


    public ReadCallback getRc() {
        return rc;
    }

    public void setRc(ReadCallback rc) {
        this.rc = rc;
    }

    private ReadCallback rc;
    public void startIDCardReader(ReadCallback callback) {
        rc = callback;
