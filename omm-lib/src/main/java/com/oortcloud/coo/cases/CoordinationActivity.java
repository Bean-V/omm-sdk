...
import com.oortcloud.coo.cases.CreateTaskActivity;
import com.oortcloud.coo.cases.IncidentListFragment;
import com.oortcloud.coo.cases.IncidentPagerAdapter;
import com.oortcloud.coo.cases.SearchPopupWindow;
...
public class CoordinationActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        title.setText("案件协同");
        tabParticipated.setText("我参与的案件");
        tabMyIncidents.setText("我的案件");
        tabUnitIncidents.setText("我单位的案件");
    }
