...
import com.oortcloud.coo.cases.IMUserCreateGroup;
import com.oortcloud.coo.cases.MucChatFragment;
...
public class IncidentDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incident_detail_cases);
    ...
    void initCheckBox() {
        ...
        if (friend == null || sessionId == null || sessionId.isEmpty()) {
            cbTaskCollaboration.setText("案件协作");
            ...
            cbTaskCollaboration.setText("案件协同");
    ...
    private ActivityResultLauncher<Intent> launcher = registerForActivityResult(
            ...
            result -> {
                if (result.getResultCode() == Activity.RESULT_OK) {
                  ...
                  com.oortcloud.coo.cases.IMUserCreateGroup imUserCreateGroup = new IMUserCreateGroup(this, this::performCreateTask);
...
//        llDetail.startAnimation(animation);
    ...
    private com.oortcloud.coo.cases.MucChatFragment mMucChatFragment;
    /**
     * 初始化聊天Fragment
     */
