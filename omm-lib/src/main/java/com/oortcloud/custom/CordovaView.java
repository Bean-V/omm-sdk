...
//        this.loadingDialog = new LoadingDialog(this.getContext(),"加载中...");
...
//        activity.getWindow().setStatusBarColor(getResources().getColor(R.color.statusbar_bg));
        //初始化
        initCordova();
    }
...
//        logoImg = new ImageView(activity);
        logoGif = new ImageView(activity);
        ...
        this.removeAllViews();
        this.addView(appView.getView(), new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
//        this.addView(textView,params2);
//        this.addView(logoImg,params0);
        this.addView(logoGif,params0);
...
//        logoImg.setVisibility(VISIBLE);
        /*try {

            gifDrawable =new GifDrawable(activity.getResources(),R.drawable.load);
...
//                .into(logoGif);
//        logoGif.setVisibility(VISIBLE);
    }
    public void hideLoading(){
        textView.setVisibility(GONE);
//        logoImg.setVisibility(GONE);
        logoGif.setVisibility(GONE);
    }
    ...
    public static void makeStatusBarTransparent(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            int option = View.SYSTEM_UI_FLAG_LAYOUT_STABLE
                    | View.SYSTEM_UI_FLAG_VISIBLE;//window.getDecorView().getSystemUiVisibility() | View.SYSTEM_UI_FLAG_LAYOUT_STABLE;// | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN;
