...
import com.oort.weichat.ui.backup.SendChatHistoryActivity;
import com.oort.weichat.ui.base.ActionBackActivity;
...
public class TokenOverdueActivity extends ActionBackActivity {
    private static final String TAG = "TokenOverdueActivity";
    ...
    public static void start(Context ctx) {
        ...
        Intent intent = new Intent(ctx, TokenOverdueActivity.class);
        // 清空activity栈，
    ...
    private void initView() {
        ...
        int status = LoginHelper.STATUS_USER_TOKEN_OVERDUE;
        ...
        mLeftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PreferenceUtils.putBoolean(TokenOverdueActivity.this, Constants.LOGIN_CONFLICT, true);
