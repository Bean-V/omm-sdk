...
public class VedioMeet extends Activity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //SelectContactsActivity.startQuicklyInitiateMeeting(this, CallConstants.Video_Meet);
        if(true) {
...
//                    }
                    ...
                    EventBus.getDefault().post(new MessageEventInitiateMeeting(CallConstants.Video_Meet, imids,false, UUID.randomUUID().toString()));
