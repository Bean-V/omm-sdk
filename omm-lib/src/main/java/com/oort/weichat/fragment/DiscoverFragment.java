...
import com.oort.weichat.ui.mucfile.UploadingHelper;
...
public class DiscoverFragment extends EasyFragment {
    ...
    private void updateBackgroundImage(String path) {
        ...
        UploadingHelper.upfile(IMUserInfoUtil.getInstance().getToken(), coreManager.getSelf().getUserId(), new File(path), new UploadingHelper.OnUpFileListener() {
            @Override
