...
import com.oort.weichat.util.downloadTask;
import com.oort.weichat.view.SaveVideoDialog;
...
public class DynamicActivityPlayVideo extends  BaseActivity implements View.OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mVideoPath = getIntent().getStringExtra(AppConstant.EXTRA_VIDEO_FILE_URI);
...
//            }
            ...
            if(FileTool.isAudio(mVideoPath)){
                findViewById(R.id.iv_audio).setVisibility(View.VISIBLE);
            }
        }

        public static void start(Context cox, String url){
            Intent in = new Intent(cox, DynamicActivityPlayVideo.class);
        ...
        private void initEvent() {
            ...
            rlControl.setOnLongClickListener(v -> {
                saveVideoDialog = new SaveVideoDialog(DynamicActivityPlayVideo.this, () -> {
                    File file = new File(mVideoPath);
                    ContentResolver localResolver = DynamicActivityPlayVideo.this.getContentResolver();
                    ...
                    ToastUtil.showToast(DynamicActivityPlayVideo.this, R.string.tip_video_save_success);
                    if (mVideoPath.startsWith("http")) {
                        ...
                        if (!f.exists()) {
                            ...
                            ContentResolver localContentResolver = DynamicActivityPlayVideo.this.getContentResolver();
                            ...
                            ToastUtil.showToast(DynamicActivityPlayVideo.this, R.string.tip_video_exists);
