...
public class ShareUtil {
    ...
    public static boolean shareInit(Activity activity, ChatMessage mShareChatMessage) {
        ...
        if(action != null){
            ...
            if(action.equals("shareFriend")) {

                String content = intent.getStringExtra("content");
                mShareChatMessage.setType(XmppMessage.TYPE_IMAGE_TEXT);


                try {
                    if (intent.getStringExtra("type").equals("review")) {
                        mShareChatMessage.setType(XmppMessage.TYPE_APP_REVIEW);
                    }
                    if (intent.getStringExtra("type").equals("video_dispatch")) {
                        mShareChatMessage.setType(XmppMessage.TYPE_VIDEO_DISPATCH);
                    }
                } catch (Exception e) {
                }
                mShareChatMessage.setContent(content);
            }
