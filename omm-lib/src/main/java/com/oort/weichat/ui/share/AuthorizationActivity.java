...
import com.oort.weichat.bean.SKLoginBean;
import com.oort.weichat.bean.SKLoginResultBean;
...
public class AuthorizationActivity extends BaseActivity {
    ...
    private void verificationLogin() {
        ...
        String secret = Md5Util.toMD5(AppConfig.apiKey + mSKLoginBean.getAppId() + coreManager.getSelf().getUserId() +
                Md5Util.toMD5(IMUserInfoUtil.getInstance().getToken() + time) + Md5Util.toMD5(mSKLoginBean.getAppSecret()));
