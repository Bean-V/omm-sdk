package com.oort.weichat.ui.xrce;
...
import com.joelc.camera2recorddemo.View.CameraRecordView;
import com.oort.weichat.bean.VideoFile;
import com.oort.weichat.ui.trill.MarqueTextView;
...
import com.oort.weichat.video.FilterPreviewDialog;
    ...
    public void onClick(final View v) {
        ...
        if (viewId == R.id.ll_filter) {
            ...
            if (UiUtils.isNormalClick(v)) {
                // 切换摄像头切换摄像头连续切换会在部分设备崩溃，测试没法根治根，只能限制点击频率了
