...
import com.oort.weichat.ui.contacts.BlackActivity;
import com.oort.weichat.util.ToastUtil;
import com.oort.weichat.view.AllowTypeDialog;
import com.oort.weichat.view.AutoReplayDialog;
import com.oort.weichat.view.MsgSyncDaysDialog;
...
public class PrivacySettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SwitchButton mSbDisplayWatermark;// 显示水印
    ...
    private void initView() {
        ...
        mSbDisplayWatermark = (SwitchButton) findViewById(R.id.mSbDisplaywatermark);
        ...
        mAutoReplay = findViewById(R.id.auto_replay_tv);

        View.OnClickListener autoReplayListener = new AutoReplayOnClickListener();
        findViewById(R.id.auto_replay_message_rl).setOnClickListener(autoReplayListener);
    }
    ...
    private void initStatus() {
        ...
        //自动回复消息
        int autoreplay = sharedPreferences.getInt("auto_replay",-1);
        mAutoReplay.setText(autoReplayValueToString(autoreplay));
        ...
        //显示水印
        boolean isDisplayWatermark = privacySetting.getAllowAtt() == 1;
        mSbDisplayWatermark.setChecked(isDisplayWatermark);
        // 获得位置公开状态
        ...
        findViewById(R.id.rl_blacklist).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mSbSupport.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mSbDisplayWatermark.setOnCheckedChangeListener(onCheckedChangeListener);
    ...
    private int autoReplayValueToString(int value) {
        int ret;
        switch (value) {
            case -1:
                ret = R.string.auto_replay_close;
                break;
            case 1:
//                ret = R.string.auto_replay_1;
//                break;
//            case 2:
//                ret = R.string.auto_replay_2;
//                break;
//            case 3:
//                ret = R.string.auto_replay_3;
//                break;
//            case 4:
//                ret = R.string.auto_replay_4;
//                break;
//            case 5:
...
//                Reporter.unreachable();
    ...
    private void submitPrivacySetting(final int index, final boolean isChecked) {
        ...
        if (index == 1) {
            ...
            params.put("allowAtt",status);
            FastSharedPreferences.get("USERPRIVACY_SAVE").edit().putString("allowAtt",status).apply();
        }
        DialogHelper.showDefaulteMessageProgressDialog(this);
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (Result.checkSuccess(PrivacySettingActivity.this, result)) {
                            ...
                            if (index == 2) {
                                ...
                                privacySetting.setAllowAtt(value);
                                tipDialog.setmConfirmOnClickListener(getString(R.string.update_success_restart), new TipDialog.ConfirmOnClickListener() {
                                    @Override
                                    public void confirm() {
                                        // todo
    ...
    private class AllowTypeOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            TextView resultView;
            int id = v.getId();
            if (id == R.id.show_last_login_time_rl) {
    ...
    private class AutoReplayOnClickListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            TextView resultView;
            if (v.getId() == R.id.auto_replay_message_rl) {
                resultView = mAutoReplay;
            } else {
                Reporter.unreachable();
                return;
            }
            AutoReplayDialog dialog = new AutoReplayDialog(mContext, new AutoReplayDialog.OnAutoReplayClickListener() {
                @Override
                public void onNewValueClick(int value) {
                    resultView.setText(autoReplayValueToString(value));
                    sharedPreferences.edit().putInt("auto_replay",value);
                }
            });
