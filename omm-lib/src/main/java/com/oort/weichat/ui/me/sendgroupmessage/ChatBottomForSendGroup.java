package com.oort.weichat.ui.me.sendgroupmessage;

import static com.oort.weichat.view.ChatBottomView.LIMIT_MESSAGE_LENGTH;
...
import com.oort.weichat.view.ChatFaceView;
...
public class ChatBottomForSendGroup extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.emotion_btn) {
            ...
            /*************************** 底部栏事件回调 **************************/
        } else if (id == R.id.send_btn) {// 发送文字的回调
            if (mBottomListener != null) {
            ...
            /********** Chat Tool View 的事件 *********/
        } else if (id == R.id.im_photo_tv) {// 相册
            if (mBottomListener != null) {
                mBottomListener.clickPhoto();
            }
        } else if (id == R.id.im_camera_tv) {// 拍照
            if (mBottomListener != null) {
                mBottomListener.clickCamera();
            }
        } else if (id == R.id.im_video_tv) {// 录像
            if (mBottomListener != null) {
                mBottomListener.clickVideo();
            }
        } else if (id == R.id.im_loc_tv) {// 位置
            if (mBottomListener != null) {
                mBottomListener.clickLocation();
            }
        } else if (id == R.id.im_card_tv) {// 名片
            if (mBottomListener != null) {
                mBottomListener.clickCard();
            }
        } else if (id == R.id.im_file_tv) {// 文件
            if (mBottomListener != null) {
