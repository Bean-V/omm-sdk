...
import com.oort.weichat.ui.UserCheckedActivity;
...
public class CoreManager {
                ...
                if (staticConfig == null) {
                    ...
                    if (configBean == null) {
                        ...
                        if (Constant.IF_CONFIG_APP_SERVICE) {
                            ...
                            Log.e(TAG, "修改网络配置------->" + JSON.toJSONString(configBean));
                        }
                    }
    ...
    private static ConfigBean readConfigBean(Context ctx) {
        ...
        return null;//JSON.parseObject(configBeanJson, ConfigBean.class);
    }
...
//        return null;
    ...
    public boolean createMucRoomId(String roomId) {
        Log.d(TAG, "createMucRoom() called with: roomName = [" + roomId + "]");
        requireXmpp();
        return mService.createMucRoomId(roomId);
    }
