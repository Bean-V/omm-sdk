...
public class LiveConstants {
    ...
    public static String LIVE_SWITCHTO_SCREEN = AppConfig.sPackageName + "live_switchto_screen";// 切换到屏幕共享
    public static String LIVE_SWTICHTO_LIVEROOM = AppConfig.sPackageName + "live_switchto_liveroom";// 切换到直播间
}
