...
import com.oort.weichat.ui.tool.SelectAreaActivity;
import com.oort.weichat.util.AvatarUtil;
...
public class BasicInfoEditActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.qccodeforoort).setOnClickListener(this);
    ...
    public void displayAvatar(final String userId) {
        ...
        AvatarHelper.getAvatarUrl_(userId, false, new AvatarHelper.CallBack() {
            @Override
            public void callback(String url) {
                String mOriginalUrl = url;
                if (!TextUtils.isEmpty(mOriginalUrl)) {
                    ...
                    bitmapList.add(mTempData.getNickName());
                    Bitmap avatar = AvatarUtil.getBuilder(mContext)
                            .setShape(AvatarUtil.Shape.SQUARE)//AvatarUtil.Shape.CIRCLE
                            .setList(bitmapList)
                    ...
                    mAvatarImg.setImageDrawable(bitmapDrawable);
                    //DialogHelper.dismissProgressDialog();
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.rl_avatar || id == R.id.avatar_img) {
            showSelectAvatarDialog();
        } else if (id == R.id.sex_select_rl) {
            showSelectSexDialog();
        } else if (id == R.id.birthday_select_rl) {
            showSelectBirthdayDialog();
        } else if (id == R.id.city_select_rl) {
        ...
        } else if (id == R.id.diy_name_rl) {
            inputDiyName();
        } else if (id == R.id.qccodeforoort) {
    ...
    private void showSelectAvatarDialog() {
        ...
        if(!PermissionUtil.checkSelfPermissions(this, new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE})){
            new DialogRequestPermission(this,DialogRequestPermission.per_type_album_camera).show();
            return;
        }
            ...
            if (resultCode == Activity.RESULT_OK) {
                if (data != null) {
                    ...
                    if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.N) {
                        ...
                        o = Uri.fromFile(new File(CameraUtil.parsePickImageResult(data)));
                    }
                    mNewPhotoUri = CameraUtil.getOutputMediaFileUri(this, CameraUtil.MEDIA_TYPE_IMAGE);
                    mCurrentFile = new File(mNewPhotoUri.getPath());
                    CameraUtil.cropImage(this, o, mNewPhotoUri, REQUEST_CODE_CROP_PHOTO, 1, 1, 300, 300);
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                    ...
                    if (photo != null) {
                        ...
                        mCurrentFile = saveimage(photo);
                        AvatarHelper.getInstance().displayUrl(mCurrentFile.getAbsolutePath(), mAvatarImg);
                        // 上传头像
...
//            System.out.println("111111111111111111==="+f.length());
    ...
    private void uploadAvatar(File file) {
        OperLogUtil.msg("uploadAvatar_file:" + file.getPath());;
        if (!file.exists()) {
            // 文件不存在
            OperLogUtil.msg("uploadAvatar_file.exists_not:" + file.getPath());;
            return;
        }
        ...
        OperLogUtil.msg("uploadAvatar_url:" + coreManager.getConfig().AVATAR_UPLOAD_URL);;
        client.post(coreManager.getConfig().AVATAR_UPLOAD_URL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                ...
                OperLogUtil.msg("uploadAvatar:" + s);;
                ...
                if (success) {
                    ...
                    AvatarHelper.userData.remove(loginUserId);
                } else {
            ...
            public void onFailure(int arg0, Header[] arg1, byte[] arg2, Throwable arg3) {
                ...
                if(arg3 != null){
                    s = s + arg3.getLocalizedMessage();
                }
                OperLogUtil.msg("uploadAvatar_onFailure:" + arg0 +  "**"+ s);;
                DialogHelper.dismissProgressDialog();
                ToastUtil.showToast(BasicInfoEditActivity.this, R.string.upload_avatar_failed);
            }
        });
    ...
    private void updateUserInfo(String userId) {
        ...
        OperLogUtil.msg("updateUserInfo:" + userId);;
        ...
        String url = null;
        url = IM_DOWN_URL + "avatar/o/" + "/" + dirName + "/" + userId + ".jpg"+"?"+ TimeUtils.f_str_2_long(TimeUtils.getCurrentTime());

        OperLogUtil.msg("IM_DOWN_URL:" + url);
        RequesManager.setUserInfo(url,mTempData.getNickName()).subscribe(new RxBus.BusObserver<String>(){
            @Override
            public void onNext(String o) {
                Log.d("tag",o);

                OperLogUtil.msg("updateUserInfoonNext:" + o);;
            }

            @Override
            public void onError(Throwable e) {

                OperLogUtil.msg("updateUserInfoonNext:" + e.getMessage());;
    ...
    private void updateData() {
        ...
        RequesManager.setUserInfo_name(mTempData.getNickName()).subscribe(new RxBus.BusObserver<String>(){
            @Override
            public void onNext(String o) {
                Log.d("tag",o);
            }
