package com.oort.weichat.ui.other;
...
import com.oort.weichat.ui.message.single.SetRemarkActivity;
...
import com.oort.weichat.view.BasicInfoWindow;
import com.oort.weichat.view.FoldTextView;
...
import com.oort.weichat.xmpp.listener.NewFriendListener;
...
public class BasicInfoActivity extends BaseActivity implements NewFriendListener {
    ...
    private void publicNumbleUser(User user) {
        ...
        if (mUserId.equals(Friend.ID_SYSTEM_MESSAGE)) {
            ...
            ImageView civ_public_av = findViewById(R.id.civ_public_av);
...
//                finish();
//            }
              if (isyanzheng == 1 && mUser.getUserType() == 0) {
                Intent intent = new Intent(BasicInfoActivity.this, ChatActivity.class);
                intent.putExtra(ChatActivity.FRIEND, mFriend);
                startActivity(intent);
                finish();
