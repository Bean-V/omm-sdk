...
import static com.oortcloud.basemodule.constant.Constant.IM_LIVE_URL;
...
import com.oort.weichat.ui.live.adapter.LiveFragmentPageAdapter;
...
public class PushFlowActivity extends BaseActivity implements RtmpHandler.RtmpListener,
    ...
    private void initView() {
        if (getIntent() != null) {
            ...
            //切换地址
            int startIndex = mRtmpURL.lastIndexOf('/');
            String endStr = mRtmpURL.substring(startIndex+1);
            mRtmpURL = IM_LIVE_URL + endStr;
        }
...
//        iAmFinishLiving();
    ...
    protected void onDestroy() {
        ...
        iAmFinishLiving();
        ReportInfo.video_num = "";
        MainActivity.UpdatePoliceInfo();
    }
