...
import com.oort.weichat.ui.backup.BackupHistoryActivity;
...
import com.oort.weichat.util.GetFileSizeUtil;
...
import com.oort.weichat.xmpp.helloDemon.IntentWrapper;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                mExitBtn.setVisibility(mExitBtn.getVisibility() == View.GONE ? View.VISIBLE : View.GONE);
                return true;
            }
        });
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            registerReceiver(mMyBroadcastReceiver, intentFilter,Context.RECEIVER_NOT_EXPORTED);
        }else{
    ...
    private void initView() {
        ...
        aboutTv.setText(getString(R.string.about_us_));
        ...
        findViewById(R.id.update_setting_rl).setOnClickListener(this);
...
//        }
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.clear_cache_rl) {// 清除缓存
            clearCache();
        } else if (id == R.id.rl_cencel_chat) {
    ...
    private class My_BroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!TextUtils.isEmpty(action)) {
                if (action.equals(OtherBroadcast.SEND_MULTI_NOTIFY)) {// 群发消息结束，关闭当前界面
                    finish();
                } else if (action.equals(OtherBroadcast.NO_EXECUTABLE_INTENT)) {// 无可执行的intent 需提醒用户
    ...
    public class CustomUpdateParser implements IUpdateParser {
        ...
        public UpdateEntity parseJson(String json) throws Exception {
            ...
            if (code == 200) {
                ...
                long currentVersionCode = getAppVersionCode(SettingActivity.this);
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        com.oortcloud.basemodule.utils.ToastUtil.showToast(SettingActivity.this,msg);
                    }
                });
