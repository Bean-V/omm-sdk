...
import com.oort.weichat.view.DataLoadView;
...
public class DataDownloadActivity extends BaseActivity {
    ...
    private void initView() {
      ...
      private void startDownload() {
        //网路延时,用户信息还未获取到，该方法已在执行
//          if (UserInfoUtil.getInstance(mContext).getLoginUserInfo() != null){
//              AppInfoManager.init(IMUserInfoUtil.getInstance().getToken() , UserInfoUtil.getInstance(mContext).getLoginUserInfo().getOort_uuid());
//          }
