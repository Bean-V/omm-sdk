...
public class PrivacySetting {
    ...
    private int allowAtt;//显示水印没字段，先暂时用这个字段来做判断
    ...
    private int screenshotProhibited;

    public int getCanForward() {
        return canForward;
    }

    public void setCanForward(int canForward) {
        this.canForward = canForward;
    }

    public int getScreenshotProhibited() {
        return screenshotProhibited;
    }

    public void setScreenshotProhibited(int screenshotProhibited) {
        this.screenshotProhibited = screenshotProhibited;
    }
    ...
    private int isShowMsgState; // 显示消息阅读状态  1：开启 0：关闭
    private int isDisplayWatermark; // 显示水印  1：开启 0：关闭
    ...
    public int getIsDisplayWatermark() {
        return isDisplayWatermark;
    }

    public void setIsDisplayWatermark(int isDisplayWatermark) {
        this.isDisplayWatermark = isDisplayWatermark;
    }
