...
public abstract class XmppMessage {
    ////////////////////////////以下为在聊天界面显示的类型/////////////////////////////////
    public static final int TYPE_CHAIN_OF_GROUPS = 11; // 群接龙
    ...
    public static final int TYPE_VIDEO_DISPATCH = 60;
    ...
    public static final int TYPE_APP_REVIEW = 1001 ;// 编辑群公告
    /* 网络传输字段 */
    ...
    public void setPacketId(String packetId) {
        ...
        LogUtils.log("fffffffpacketId" + packetId);
