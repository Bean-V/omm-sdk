package com.oort.weichat.bean.circle;
...
/**
 * @项目名称: 奥陌陌
 * @包名: com.oort.weichat.bean.circle
 * @作者:王阳
    ...
    public static class Resource implements Serializable {
        ...
        public String getOriginalUrl() {
            if (!TextUtils.isEmpty(originalUrl)){
                originalUrl =  Constant.IM_DOWN_URL +originalUrl.substring(originalUrl.indexOf("u/") );
                return originalUrl;
        ...
        public String getThumbnailUrl() {
            if (!TextUtils.isEmpty(thumbnailUrl)){
                thumbnailUrl =  Constant.IM_DOWN_URL +thumbnailUrl.substring(thumbnailUrl.indexOf("u/") );
                return thumbnailUrl;
