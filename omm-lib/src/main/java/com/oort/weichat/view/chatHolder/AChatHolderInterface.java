...
*/
     ...
     * @return 密聊消息状态
     */
    protected EncryptMessageHelper.EncryptMessageStatus checkEncryptMessage(ChatMessage message, String content) {
        return EncryptMessageHelper.checkAndProcessEncryptMessage(mContext, message, content, isMysend, mToUserId, mLoginUserId);
    }
     ...
     * @return 是否处理成功
     */
    protected boolean handleEncryptMessageClick(ChatMessage message, String encryptedContent, TextView textView) {
        return EncryptMessageHelper.handleEncryptedMessageClick(mContext, message, encryptedContent, textView, isMysend);
    }
    ...
    protected void handleEncryptNotEnabledClick() {
        EncryptMessageHelper.handleEncryptNotEnabledClick(mContext);
    }
}
