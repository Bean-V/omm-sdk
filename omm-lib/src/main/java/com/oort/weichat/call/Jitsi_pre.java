...
public class Jitsi_pre extends BaseActivity {
    ...
    public void helloEventBus(final MessageEventSipPreview message) {// 对方接听
        ...
        Jitsi_connecting_second.start(this, mLoginUserId, call_toUser, type, meetUrl,false,roomId);
        finish();
    ...
    public void helloEventBus(final MessageEventSipEVent message02) {
        ...
        if (message02.message.getType() == XmppMessage.TYPE_CONNECT_VOICE
            ...
            EventBus.getDefault().post(new MessageEventSipPreview(null, null, message02.message));
        }
    }
    @Subscribe(threadMode = ThreadMode.MAIN)
