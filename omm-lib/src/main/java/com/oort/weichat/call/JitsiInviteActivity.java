...
public class JitsiInviteActivity extends BaseActivity {
    ...
    private void initAction() {
        ...
        findViewById(R.id.ll_select_p).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                tool.ceateRoom(JitsiInviteActivity.this, coreManager);
    ...
    private void intent() {
        if (TextUtils.isEmpty(roomId)) {
            ...
            Log.e("Jitsi_connecting_second","JitsiInviteActivity" + voicejid);
            Jitsi_connecting_second.start(this, voicejid, mLoginUserId, type,"",false,roomId);
            finish();
        }
    }
