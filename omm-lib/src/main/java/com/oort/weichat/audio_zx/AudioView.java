package com.oort.weichat.audio_zx;
...
//        }
    ...
    private void bindData(String packetId, String filePath, String content, long timeLen, String objectId) {
        voiceMsgId = packetId;
        path = filePath;
