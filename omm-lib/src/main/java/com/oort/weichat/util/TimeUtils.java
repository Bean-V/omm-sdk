...
import static com.oort.weichat.util.Constants.KEY_TIME_DIFFERENCE;
...
public class TimeUtils {
    ...
    public static SimpleDateFormat friendly_format2 = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    ...
    public static String getFriendlyTimeDesc(Context context, long time) {
        ...
        if (delaySeconds < 10) {// 小于10秒，显示刚刚
            ...
            desc = context.getString(R.string.friendly_time_just_now);
