...
*/
    ...
    public static String getMsgContent(ChatMessage chatMessage) {
        ...
        } else if (type == XmppMessage.TYPE_IMAGE_TEXT || type == XmppMessage.TYPE_IMAGE_TEXT_MANY) {
        ...
        } else if (type == XmppMessage.TYPE_REPLAY) {
            text = "[" + MyApplication.getInstance().getString(R.string.replay) + "]";
        } else if (type == XmppMessage.TYPE_APP_REVIEW) {
            text = "[智慧审批]";
        } else if (type == XmppMessage.TYPE_VIDEO_DISPATCH) {
            text = "[视频调度]";
