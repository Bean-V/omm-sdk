package com.oort.weichat.util.secure.chat;
...
public class SecureChatUtil {
    ...
    public static String getDHPrivateKey(String key) {
        return PreferenceUtils.getString(MyApplication.getContext(), "DH_PRIVATE_KEY_" + key, "");
    }

    /**
     * userId保存dh私钥-aes set
     */
    public static void saveDHPrivateKey(String key, String value) {
        PreferenceUtils.putString(MyApplication.getContext(), "DH_PRIVATE_KEY_" + key, value);
    }

    /**
     * userId保存dh公钥-aes set
     */
    public static void saveDHPublicKey(String key, String value) {
        PreferenceUtils.putString(MyApplication.getContext(), "DH_PUBLIC_KEY_" + key, value);
    }

    /**
     * userId获取dh公钥-aes get
     */
    public static String getDHPublicKey(String key) {
        return PreferenceUtils.getString(MyApplication.getContext(), "DH_PUBLIC_KEY_" + key, "");
    }
