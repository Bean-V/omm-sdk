    ...
    public void processStanza(Stanza packet) {
        ...
        if (packet instanceof Message) {
            ...
            if (message.getType() == Message.Type.chat) {
                LogUtils.e("msg", "单聊：" + message.getStanzaId());
                LogUtils.e("msg", "单聊：" + message.getBody());
            } else if (message.getType() == Message.Type.groupchat) {
                LogUtils.e("msg", "群聊：" + message.getStanzaId());
                LogUtils.e("msg", "群聊：" + message.getBody());
            } else if (message.getType() == Message.Type.error) {
                LogUtils.e("msg", "error：" + message.getStanzaId());
                LogUtils.e("msg", "error：" + message.getBody());
            } else {
                LogUtils.e("msg", "else：" + message.getStanzaId());
