...
class ReceiptManagerNew {
    ...
    private class Enable extends IQ {
        ...
        private static final String NAMESPACE = "xmpp:oort:ack";
        ...
        protected IQChildElementXmlStringBuilder getIQChildElementBuilder(IQChildElementXmlStringBuilder xml) {
            xml.rightAngleBracket().append("enable");
            return xml;
        }
    }
    ...
    private class Receipt extends IQ {
        ...
        @Override
        protected IQChildElementXmlStringBuilder getIQChildElementBuilder(IQChildElementXmlStringBuilder xml) {
            xml.rightAngleBracket().append(TextUtils.join(",", messageIdList));
            return xml;
        }
    }
    ...
    private class MyIqProvider extends IQProvider<Enable> {
        ...
        @Override
        public Enable parse(org.jivesoftware.smack.xml.XmlPullParser parser, int initialDepth, XmlEnvironment xmlEnvironment) throws XmlPullParserException, IOException, SmackParsingException {
            return new Enable();
        }
    }
