...
//        coreParameters.videoHeight = RESFlvData.VIDEO_HEIGHT;
        coreParameters.videoWidth = RESFlvData.mRealSizeWidth;
        coreParameters.videoHeight = RESFlvData.mRealSizeHeight;
                ...
                switch (state) {
                    ...
                    case STATE.RUNNING:
                        ...
                        if (writeMsgNum >= (maxQueueLength * 2 / 3) && flvData.flvTagType == RESFlvData.FLV_RTMP_PACKET_TYPE_VIDEO && flvData.droppable) {
                         ...
                         int res = RtmpClient.write(jniRtmpPointer, flvData.byteBuffer, flvData.byteBuffer.length, flvData.flvTagType, flvData.dts);
                        if (res == 0) {
