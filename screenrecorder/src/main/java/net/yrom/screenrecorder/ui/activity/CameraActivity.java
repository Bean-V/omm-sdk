...
import net.yrom.screenrecorder.databinding.ActivityCameraBinding;
...
public class CameraActivity extends Activity implements Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    private net.yrom.screenrecorder.databinding.ActivityCameraBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(binding.getRoot());
         ...
         btnPushToRtmp = binding.btnPushToRtmp;
         etRtmpAddress = binding.etRtmpAddress;
         svCamera = binding.svCamera;
        ...
        btnPushToRtmp.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onViewClicked() {
        ...
        rtmpAddr = "rtmp://oort.oortcloudsmart.com:1935/live/10000006_1584088518";
