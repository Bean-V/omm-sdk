 ...
 * Created by zzj on 2023/3/7 14:38
 * Version 1.0
 * Description：侧滑RecycleView
 */
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    // 获取触碰点所在的view
                    mFlingView = (ViewGroup) getChildAt(mPosition - ((LinearLayoutManager)
...
//            obtainVelocity(e);
            switch (e.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mMenuViewWidth != INVALID_CHILD_WIDTH) {
                        ...
                        float dx = mLastX - x;
                        //itemView移动距离
                        float scrollX = mFlingView.getScrollX() + dx;
                        if (scrollX <= mMenuViewWidth && scrollX > 0) {
    ...
    public int pointToPosition(int x, int y) {
        int firstPosition = ((LinearLayoutManager) Objects.requireNonNull(getLayoutManager()))
