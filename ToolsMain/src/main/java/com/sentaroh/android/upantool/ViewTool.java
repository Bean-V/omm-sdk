...
public class ViewTool {
    ...
    public static void confirm_to_action(Context context, String title, String message, DialogInterface.OnClickListener ls)
    {
        AlertDialog alert = null;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle((title != null) ? title : context.getString(R.string.tip))
                .setMessage(message)
    ...
    public static void confirm_to_action_(Context context, String title, String message, String confirmTitle,DialogInterface.OnClickListener ls)
    {
        AlertDialog alert = null;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle((title != null) ? title : context.getString(R.string.tip))
                ...
                .setPositiveButton(confirmTitle, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    static int dp2p_x(Context context, float dpValue){
        float scale=context.getResources().getDisplayMetrics().density;
        return (int)(dpValue*scale+0.5f);
    }
