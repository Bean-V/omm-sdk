...
public class LogHelper {
    ...
    public static final String LIBRARY_PACKAGE_NAME = "com.blackhao.utillibrary";
    //单例
...
//    public boolean isIS_WRITE_FILE() {
//        return IS_WRITE_FILE;
//    }
//
//    public void setIS_WRITE_FILE(boolean IS_WRITE_FILE) {
//        this.IS_WRITE_FILE = IS_WRITE_FILE;
//    }

    //是否需要写文件
    final private boolean IS_WRITE_FILE = false;
    //文件路径
    ...
    public void initLogFile(Context context) {
        if (context != null) {
            ...
            LOG_FILE_PATH = Environment.getExternalStorageDirectory() + File.separator + "QQQChatLog";
        }
    }
