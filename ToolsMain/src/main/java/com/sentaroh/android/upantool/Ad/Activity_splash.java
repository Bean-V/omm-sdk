package com.sentaroh.android.upantool.Ad;
...
import com.sentaroh.android.upantool.ActivityMain_;
...
import com.sentaroh.android.upantool.ViewTool;
...
//        private TTAdNative mTTAdNative;
        ...
        private String mCodeId = "888089445";//"888088924";
        private boolean mIsExpress = false; //是否请求模板广告
        private boolean mIsHalfSize = false;
        private static Activity_splash _Instance;
        public static  Activity_splash Inst(){
            return _Instance;
        }
...
//            mTTAdNative = AdManager.get().createAdNative(this);
...
/*
    public void loadSplashAd(){
        ...
        goToMainActivity();
            //ViewTool.confirm_to_action(this,null,AppSigning.getSha1(this),null);
            if(true) {
        ...
        goToMainActivity();
            AdSlot adSlot=null;
            float splashWidthDp = ViewTool.getScreenWidthDp(this);
            int splashWidthPx = ViewTool.getScreenWidthInPx(this);
            int screenHeightPx = ViewTool.getScreenHeight(this);
            float screenHeightDp = ViewTool.px2dip(this, screenHeightPx);
...
//            float expressViewHeight = ChuanShanJiaUtil.getHeight(this);
            ...
            mTTAdNative.loadSplashAd(adSlot, new TTAdNative.SplashAdListener() {
                ...
                public void onSplashAdLoad(com.bytedance.sdk.openadsdk.TTSplashAd ad) {
                    ...
                    if (view != null && mSplashContainer != null && !Activity_splash.this.isFinishing()) {
...
*/
        ...
        private void goToMainActivity(){
            Intent intent=new Intent(this, ActivityMain_.class);
            startActivity(intent);  //移除所有视图
            finish();
        }
