...
import com.oortcloud.appstore.databinding.ItemHomeAppLangLayoutBinding;
 ...
 */
public class HomeAppLangAdapter extends BaseRecyclerViewAdapter<AppInfo> {

    public HomeAppLangAdapter(Context context , List<AppInfo> list) {
        super(context);
        lists = list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.item_home_app_lang_layout, viewGroup , false);
...
//        holder.install.setState(DownloadProgressButton.STATE_DOWNLOADING);
    ...
    public void reloadView(ArrayList<AppInfo> arr){
        lists.clear();
        lists.addAll(arr);
        notifyDataSetChanged();
    }
    class ViewHolder extends RecyclerView.ViewHolder {
        private ItemHomeAppLangLayoutBinding binding; // 假设布局文件为item_app_info.xml
        ImageView appImg;
        TextView appName;
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ItemHomeAppLangLayoutBinding.bind(itemView);
