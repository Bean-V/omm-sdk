 ...
 * @function：
 * @version： v1.0
 * @author: zhangzhijun/@date: 2020/1/13 17:10
 */
...
//        return new AlertDialog.Builder(context,R.style.Dialog_Alert);
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context,
        ...
        return getDialog(context)
                .setTitle(title)
                .setView(view)
                .setPositiveButton(context.getString(R.string.button_ok), positiveListener)
                .setNegativeButton(context.getString(R.string.base_cancel), null);
    }
    ...
    public static AlertDialog.Builder getConfirmDialog(
        ...
        return getDialog(context)
                .setMessage(message)
                .setPositiveButton(context.getString(R.string.dialog_ok), positiveListener)
                .setNegativeButton(context.getString(R.string.dialog_cancel), negativeListener);
    }
...
//        CommentItemAdapter com.oortcloud.contacts.adapter = new CommentItemAdapter(context);
//        com.oortcloud.contacts.adapter.setOnItemClickListener(listener);
//        recyclerView.setAdapter(com.oortcloud.contacts.adapter);
