...
//    private static String uuid = AppMallinit.store_uuid;
    ...
    private static Observable<String> post(String url) {
        ...
        headerMap.put("appid", Constant.APP_ID);
        headerMap.put("secretkey", Constant.SECRET_KEY);
headerMap.put("requestType", "app");
...
headerMap.put("requestType", "app");
    ...
    public static Observable<String> cloudSchool(String token,String uuid) {
        ...
        bodyMap.put("uuid", uuid);
        bodyMap.put("item", 2);
        return RetrofitServiceManager.PostObservable(HttpConstants.cloudclassroom_more,  headerMap, bodyMap);
    }


    public static Observable<String> uploadfile(String token,File file) {
...
headerMap.put("requestType", "app");
        ...
        return RetrofitServiceManager.PostFileObservable(HttpConstants.UPLOAD_FILE,  headerMap,file);
    }
...
headerMap.put("requestType", "app");
        ...
        return RetrofitServiceManager.PostObservable_url(HttpConstants.notice_list,  headerMap, bodyMap);
    }
