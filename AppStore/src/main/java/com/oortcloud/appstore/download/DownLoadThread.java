...
public class DownLoadThread implements Runnable {
    ...
    public DownLoadThread( DownLoadThreadInfo downLoadThreadInfo ,String downloadUrl , String localFilePath ) {

        this.handler = downLoadThreadInfo.getHandler();
    ...
    public void run() {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("appid",
                    Constant.APP_ID);
            httpURLConnection.setRequestProperty("secretkey",
                    Constant.SECRET_KEY);
            httpURLConnection.setRequestProperty("requestType",
                    "app");//"accessToken",  AppStoreInit.getToken()
            ...
            // 输出当前线程
//            Log.v("msg" , "当前线程" + threadId + " 下载开始位置:" + startSize
//                    + " 下载结束位置:" + endSize);
