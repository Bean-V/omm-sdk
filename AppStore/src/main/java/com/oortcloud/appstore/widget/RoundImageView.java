 ...
 * @function：
 * @version： v1.0
 * @author: zhangzhijun/@date: 2020/1/16 10:14
 */
public class RoundImageView  extends AppCompatImageView {
    ...
    public RoundImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundImageView, 0, 0);
                ...
                isCoverSrc = ta.getBoolean( R.styleable.RoundImageView_is_cover_src, isCoverSrc);

                isCircle = ta.getBoolean( R.styleable.RoundImageView_circle, isCircle);

                borderWidth = ta.getDimensionPixelSize(R.styleable.RoundImageView_border_width, borderWidth);

                borderColor = ta.getColor( R.styleable.RoundImageView_border_color, borderColor);

                innerBorderWidth = ta.getDimensionPixelSize( R.styleable.RoundImageView_inner_border_width, innerBorderWidth);

                innerBorderColor = ta.getColor(R.styleable.RoundImageView_inner_border_color, innerBorderColor);

                cornerRadius = ta.getDimensionPixelSize( R.styleable.RoundImageView_radius, cornerRadius);

                cornerTopLeftRadius = ta.getDimensionPixelSize( R.styleable.RoundImageView_corner_top_left_radius, cornerTopLeftRadius);

                cornerTopRightRadius = ta.getDimensionPixelSize(R.styleable.RoundImageView_corner_top_right_radius, cornerTopRightRadius);

                cornerBottomLeftRadius = ta.getDimensionPixelSize(R.styleable.RoundImageView_corner_bottom_left_radius, cornerBottomLeftRadius);
                ...
                maskColor = ta.getColor(R.styleable.RoundImageView_mask_color, maskColor);
