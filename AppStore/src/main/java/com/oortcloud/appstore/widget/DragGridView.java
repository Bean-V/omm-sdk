 ...
 * @function：
 * @version： v1.0
 * @author: zhangzhijun/@date: 2020/1/19 09:46
 */
public class DragGridView extends GridView {
    ...
    public DragGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取最大高度值，这里假设从布局参数中获取，你可以根据实际情况修改
        maxHeight = getContext().getResources().getDimensionPixelSize(R.dimen.max_grid_view_height);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (isDrag && mDragImageView != null && dragEnable) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 根据自适应高度和最大高度比较，确定最终高度
        int finalHeight = measuredHeight <= maxHeight? measuredHeight : maxHeight;

        // 设置最终高度并打印出来
        setMeasuredDimension(getMeasuredWidth(), finalHeight);
        System.out.println("DragGridView最终实际高度: " + finalHeight);
    }
}