...
import com.oortcloud.appstore.adapter.HeaderViewAdapter;
 ...
 * Dat:2017/11/13
 */
public class HeaderRecyclerView extends AutoHeightRecyclerView {

    //内置的HeaderViewAdapter包装对象。
    private HeaderViewAdapter mAdapter;

    private MoveModuleListener moveModuleListener;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (moveModuleListener != null){
                    moveModuleListener.shiftListener();
                }
    ...
    public void setShiftListener(MoveModuleListener listener){
        moveModuleListener = listener;
    }
}
