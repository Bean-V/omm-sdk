...
public class DownloadLoadingView extends View {
    ...
    public DownloadLoadingView(Context context, AttributeSet attrs) {
        ...
        mRadius = typedArray.getDimension(R.styleable.DownloadLoadingView_dlv_radius, RADIUS_DEFAULT);
        ...
        mBackgroundColor = typedArray.getColor(R.styleable.DownloadLoadingView_backgroundColor, getResources().getColor(R.color.download_loading_view_bg_color));
