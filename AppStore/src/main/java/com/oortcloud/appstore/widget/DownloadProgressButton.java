...
/**
 * @filename:
 * @function： 自定义下载控件Button
 * @version： v1.0
 * @author: zhangzhijun/@date: 2020/2/1 10:58
 *
 */
...
public class DownloadProgressButton extends AppCompatTextView {
    ...
    public static final int STATE_OPEN = 4;//下载完成

    public static final int STATE_Apply = 5;//申请

    public static final int STATE_Reject = 6;//驳回

    public static final int STATE_Reviewing = 7;//正在审核

    public static final int STATE_Unused = 8;//正在审核
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mBackgroundColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_color, Color.parseColor("#FF007AFF"));
            mBackgroundSecondColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_second_color, Color.parseColor("#F2F2F2"));
        ...
        if (mState != state) {//状态确实有改变
            ...
            switch (state) {
                case STATE_Apply:
                    ...
                    mBackgroundColor = Color.parseColor("#0d00BA4A");
                    mTextColor = Color.parseColor("#00BA4A");
                    mCurrentText = getContext().getString(R.string.apply_str);
                    break;
                case STATE_Reject:
                    mBackgroundColor = Color.parseColor("#0dE30000");
                    mTextColor = Color.parseColor("#E30000");
                    mCurrentText = getContext().getString(R.string.reject_str);
                    break;
                case STATE_Reviewing:
                    mBackgroundColor = Color.parseColor("#0dE36000");
                    mTextColor = Color.parseColor("#E36000");
                    mCurrentText = getContext().getString(R.string.review_str);;
                    break;

                case STATE_Unused:
                    mBackgroundColor = Color.parseColor("#0dE36000");
                    mTextColor = Color.parseColor("#00BA4A");
                    mCurrentText = getContext().getString(R.string.unused_str);
                    break;
                case STATE_OPEN:
                    mBackgroundColor = Color.parseColor("#1156a6");
                    mTextColor = Color.parseColor("#ffffff");
                    mCurrentText = getContext().getString(R.string.open_str);
                    break;
                case STATE_NORMAL:
                    mBackgroundColor = Color.parseColor("#f2f2f2");
                    mTextColor = Color.parseColor("#1156a6");
                    mCurrentText = getContext().getString(R.string.load_str);;
                    break;
