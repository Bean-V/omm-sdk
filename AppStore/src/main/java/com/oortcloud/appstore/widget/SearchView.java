 ...
 * @function：
 * @version： v1.0
 * @author: zhangzhijun/@date: 2020/1/12 18:23
 */
...
public class SearchView extends LinearLayout implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        mSsearch = findViewById(R.id.tv_search);

        ivDelete.setOnClickListener(this);
        btnBack.setOnClickListener(this);
        mSsearch.setOnClickListener(this);
...
//                lvTips.setVisibility(VISIBLE);
    ...
    public void onClick(View view) {
        ...
        if (viewID == R.id.search_et_input) {
//            lvTips.setVisibility(VISIBLE);
        } else if (viewID == R.id.search_iv_delete) {
            etInput.setText("");
            ivDelete.setVisibility(GONE);
            mListener.onDelete();
        } else if (viewID == R.id.search_btn_back) {
