...
public class ReportInfo {
    ...
    public static String elements = "水产大厦";     //坐标位置  必填
    public static String interphone = "";   //对讲机
    public static double latitude = 0;  //114.064552,22.548457  //纬度
    public static double longitude = 0;    //经度

    public static double lastlatitude = 0;  //114.064552,22.548457  //纬度
