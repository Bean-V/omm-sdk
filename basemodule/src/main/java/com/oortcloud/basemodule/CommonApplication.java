...
public class CommonApplication extends Application {
    ...
    public static void setIsTab(boolean pIsTab) {
        CommonApplication.pIsTab = pIsTab;
    }

    public static boolean pIsTab;
    //log路径
...
//        String seralnum = DeviceIdFactory.getSerialNumber();
        String seralnum = DeviceIdFactory.getDeviceIdentifier(getAppContext());
        return seralnum;
    }
}
