package com.oortcloud.basemodule.views.leafchart.bean;
...
public class Axis {
     ...
     * 刻度集合
     */
    private List<com.oortcloud.basemodule.views.leafchart.bean.AxisValue> values = new ArrayList<>();
    ...
    public Axis(List<com.oortcloud.basemodule.views.leafchart.bean.AxisValue> values) {
        this.values = values;
    }

    public List<com.oortcloud.basemodule.views.leafchart.bean.AxisValue> getValues() {
        return values;
    }

    public void setValues(List<com.oortcloud.basemodule.views.leafchart.bean.AxisValue> values) {
        this.values = values;
    }
