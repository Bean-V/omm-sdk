...
public class UserInfo {
    ...
    /**
     * oort_uuid : d7921bb9-e9e1-4c4f-9d3e-0b3dc09fb17f
     * oort_loginid : 18923705641
     * oort_name : 奥尔特云
     * oort_namepy : aoerteyun
     * oort_namefl : aety
     * oort_code : 18923705641
     * oort_depname : 技术支持与运维
     * oort_depcode : 99999000
     * oort_rdepname :
     * oort_rdepcode :
     * oort_idcard :
     * oort_photo : http://oort.oortcloudsmart.com:31610/oort/oortwj1/group1/default/20210506/20/24/4/1620303889701.jpg
     * oort_sex : 0
     * oort_phone : 18923705641
     * oort_pphone :
     * oort_email :
     * oort_policetype : 9
     * oort_usertype : 1
     ...
     * userlevelID : 1
     * userlevel : vip0
     * userlevelurl : oort/oortwj1/group1/default/20210427/15/50/4/邮箱.png
     * contribute : 0
     * honor : 0
     * fans : 0
     */
    ...
    private int oort_manager;
    private int oort_isadmin;
    ...
    public int getOort_policetype() {
        return oort_policetype;
    }

    public void setOort_policetype(int oort_policetype) {
        this.oort_policetype = oort_policetype;
    }
    ...
    public int getOort_manager() {
        return oort_manager;
    }

    public void setOort_manager(int oort_manager) {
        this.oort_manager = oort_manager;
    }

    public int getOort_isadmin() {
        return oort_isadmin;
    }

    public void setOort_isadmin(int oort_isadmin) {
        this.oort_isadmin = oort_isadmin;
    }
