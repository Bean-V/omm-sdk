...
public class LoginTool {
    ...
    public static String URL = "http://oort.oortcloudsmart.com:21310/";//3161031610
    public static String IMURL = "http://oort.oortcloudsmart.com:21300/";
    ...
    public static String GETUSERINFO = URL + "bus/apaas-sso/sso/v1/getUserInfo";

    public static String LOGIN_SECURE_UPLOAD_KEY = IMURL + "authkeys/uploadLoginKey";
...
//        }
        ...
        String salt = (String) params.remove("salt");
        if (salt == null) {
    ...
    private static void generateBeforeLoginParam(Context ctx, Map<String, Object> params) {
        String salt = (String) params.remove("salt");
        if (salt == null) {
            salt = String.valueOf(System.currentTimeMillis());
        }
    ...
    public static void login(Context ctx,String account,String loginPassword,LoginRes res){
        ...
        if(true){
            ...
            String userId = FastSharedPreferences.get("USERINFO_SAVE").getString("userId","");
            if(!token.equals("") && !userId.equals("")){

                res.loginRes(200,userId,token,"","","");
                return;
            }
        }
                    ...
                    public void loginRes(int grcode, String userId, String token, String data, String data1, String data2) {
                        ...
                        loginIM(ctx,url,code,p, new LoginRes() {
                            ...
                            public void loginRes(int code, String userId, String token, String data, String data1, String data2) {
                                ...
                                FastSharedPreferences.get("USERINFO_SAVE").edit().putString("userId",token).apply();
...
//
    ...
    private static void myGetCode(Context ctx, String account, byte[] key,String password,LoginRes res) {
        ...
        HttpUtils.post().url(GETLODINCODEURL)
                .params(map)
                .build(true, true)
                .execute(new BaseCallback<LoginSsosign>(LoginSsosign.class, false) {
    ...
    private static void getCode(Context ctx, String account, byte[] key, LoginRes res) {
        ...
        HttpUtils.post().url(GETLODINCODEURL)
                .params(params)
                .build(true, true)
                .execute(new BaseCallback<LoginCode>(LoginCode.class, false) {
    ...
    private static void requestPrivateKey(Context ctx, String userId, byte[] key,LoginRes res) {
        ...
        HttpUtils.post().url(GETLPKey)
                .params(params)
                .build(true, true)
                .execute(new BaseCallback<PayPrivateKey>(PayPrivateKey.class, false) {
    ...
    private static void makeRsaKeyPair(Context ctx, String userId,
        ...
        HttpUtils.post().url(LOGIN_SECURE_UPLOAD_KEY)
                .params(params)
                .build(true, true)
                .execute(new BaseCallback<Void>(Void.class, false) {
