...
public class SkinUtils {
    ...
    public static List<Skin> defaultSkins = Arrays.asList(
            // 绿色主题，白色标题绿色控件，
            new Skin(R.string.skin_qian_dou_green, 0xffffff, 0x1156a6, false),
            // 蓝色主题，白色标题蓝色控件，
    ...
    private static Skin requireSkin(Context ctx) {
        ...
        synchronized (SkinUtils.class) {
            if (currentSkin == null) {
                int savedSkinColor = PreferenceUtils.getInt(ctx, Constant.KEY_SKIN_NAME, DEFAULT_SKIN.hashCode());
    ...
    public static void setSkin(Context ctx, Skin skin) {
        currentSkin = skin;
        PreferenceUtils.putInt(ctx, Constant.KEY_SKIN_NAME, skin.hashCode());
    }
