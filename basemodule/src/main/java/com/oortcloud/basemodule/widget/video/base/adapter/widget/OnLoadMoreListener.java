package com.oortcloud.basemodule.widget.video.base.adapter.widget;
...
import com.oortcloud.basemodule.widget.video.base.adapter.interfaces.OnLoadMorePresenter;
...
public abstract class OnLoadMoreListener extends RecyclerView.OnScrollListener implements OnLoadMorePresenter {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        if(recyclerView.getLayoutManager() instanceof LinearLayoutManager){
            ...
            //暂不支持瀑布流加载更多
            Log.d(TAG,"OnLoadMoreListener-->暂不支持瀑布流加载更多");
        }
    }
