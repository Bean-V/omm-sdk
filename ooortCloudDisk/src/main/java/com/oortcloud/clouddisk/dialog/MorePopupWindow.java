...
public class MorePopupWindow extends PopupWindow {
    ...
    public MorePopupWindow(final Activity context , View view){
        super(context);
        ...
        menuView = (ViewGroup) inflater.inflate(R.layout.popup_more, null);
...
//        this.setAnimationStyle(R.style.Buttom_Popwindow);
        ...
        showAsDropDown(view,
                -(getContentView().getMeasuredWidth() - view.getWidth()-180),
                -80);
    }

    private void  initEvent() {
        menuView.findViewById(R.id.sort_ll).setOnClickListener(v -> {
            new SortPopupWindow((Activity) mContext  ,v);
            dismiss();
        });

        menuView.findViewById(R.id.about_ll).setOnClickListener(v -> {
