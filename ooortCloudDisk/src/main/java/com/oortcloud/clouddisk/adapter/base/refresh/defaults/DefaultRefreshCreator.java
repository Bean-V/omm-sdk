package com.oortcloud.clouddisk.adapter.base.refresh.defaults;
...
import com.oortcloud.clouddisk.adapter.base.refresh.RefreshViewCreator;

/**
 * @FileName: DefaultRefreshCreator.java
 * @Author: ZZJun / @CreateDate: 2021/1/10 21:50
 * @Version: 1.0
 * @Function: 默认样式的刷新头部辅助类
 */
