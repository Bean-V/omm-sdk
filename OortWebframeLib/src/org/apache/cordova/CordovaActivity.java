...
public class CordovaActivity extends Activity {
    ...
    //protected GifImageView logoGif;
...
// 使用状态栏高度作为上边距
        params3.topMargin = 0;//statusBarHeight;  // 替换原来的固定值90

        rl.setBackgroundColor(Color.TRANSPARENT);
        rl.addView(appView.getView(), params3);
...
//            window.setStatusBarColor(Color.parseColor("#1156a6"));
//        } else {
