 ...
 * Created by zzj on 2022/12/15 18:34
 * Version 1.0
 * Description：
 */
...
//        Log.v("TAG", "inheritContext--"+ inheritContext);
//        Log.v("TAG", "readAndroidTheme--"+ readAndroidTheme);
//        Log.v("TAG", "readAppTheme--"+ readAppTheme);
//        Log.v("TAG", "wrapContext--"+ wrapContext);
        View view = null;
